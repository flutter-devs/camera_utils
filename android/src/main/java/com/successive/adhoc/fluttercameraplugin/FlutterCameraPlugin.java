package com.successive.adhoc.fluttercameraplugin;
...
import com.successive.adhoc.fluttercameraplugin.util.Utils;
 ...
 * FlutterCameraPlugin
 */
public class FlutterCameraPlugin implements MethodCallHandler, PluginRegistry.ActivityResultListener {

    private static final String TAG = FlutterCameraPlugin.class.getSimpleName();
    private static final String METHOD_CHANNEL = "flutter_camera_plugin";
    ...
    public FlutterCameraPlugin(Activity activity) {
    ...
    public static void registerWith(Registrar registrar) {
        ...
        FlutterCameraPlugin cameraPlugin = new FlutterCameraPlugin(registrar.activity());
